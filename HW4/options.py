...
parser.add_argument('--dataset_root', type=str, default='data/',help='root of train/val folders')
parser.add_argument('--test_root',   type=str, default='data/test/degraded/',help='folder with degraded test images')

parser.set_defaults(de_type=['rain', 'snow'])  
...
parser.add_argument("--ckpt_dir",type=str,default="ckpt/l1_ssim_tv/test",help = "Name of the Directory where the checkpoint is to be saved")
